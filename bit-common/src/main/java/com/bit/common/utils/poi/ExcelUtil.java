...
import com.bit.common.core.text.Convert;
import com.bit.common.exception.UtilException;
import com.bit.common.utils.DateUtils;
import com.bit.common.utils.DictUtils;
import com.bit.common.utils.StringUtils;
import com.bit.common.utils.file.FileTypeUtils;
import com.bit.common.utils.file.FileUtils;
import com.bit.common.utils.file.ImageUtils;
import com.bit.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = BitConfig.getDownloadPath() + filename;
        File desc = new File(downloadPath);
        if (!desc.getParentFile().exists()) {
            try {
                Files.createDirectories(desc.getParentFile().toPath());
            } catch (IOException e) {

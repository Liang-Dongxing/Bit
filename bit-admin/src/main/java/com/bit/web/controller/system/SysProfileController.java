...
import com.bit.common.utils.SecurityUtils;
import com.bit.common.utils.StringUtils;
import com.bit.common.utils.file.FileUploadUtils;
import com.bit.common.utils.file.MimeTypeUtils;
import com.bit.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(BitConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
